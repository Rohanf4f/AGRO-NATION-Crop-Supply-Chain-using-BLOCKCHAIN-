...
export default function RawMaterialInfo(props) {
  ...
  async function getRawMaterialData() {
    ...
    let display = <div>
      ...
      <p>Crop Product Transaction contract address: <Link to={{ pathname: `/supplier/view-transaction/${data[6]}`, query: { address: data[6], account: account, web3: web3 } }}>{data[6]}</Link>
      </p>
      <CustomStepper
