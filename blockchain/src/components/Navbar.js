    ...
    render(){
        ...
        if(this.props.location.pathname.split('/')[1] === "owner") {
            return ( 
                <nav className="nav-wrapper black darken-3">
                    <div className="container">
                        <a href="#" className="brand-logo left"><i style={{marginTop: 5}} className="material-icons">local_Market</i>Agriculture Supply Chain</a>
            ...
            return(
                <nav className="nav-wrapper black darken-3">
                    <div className="container">
                    <a href="#" className="brand-logo"><i style={{marginTop: 5}} className="material-icons">local_Market</i>Agriculture Supply Chain</a>
                        <ul className="right hide-on-med-and-down">
                            <li><NavLink to="/">Home</NavLink></li>
                            <li><NavLink to="/upload">Upload</NavLink></li>
                            <li><NavLink to="/view">View</NavLink></li>
                            <li><NavLink to="/doctors">Farmers</NavLink></li>
                            <li>
                            { this.props.account
                                ? <img
                                    style={{marginTop: 15, marginLeft: 15}}
